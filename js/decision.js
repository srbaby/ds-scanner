const EXECUTION_PRIORITY = Object.freeze({ SELL: 0, REDUCE: 1, ADD: 2, BUY: 2, HOLD: 3 });
...
function dashboardIsFresh(dashboard, day) {
  return Boolean(dashboard?.generated_at && String(dashboard.generated_at).slice(0, 10) === day);
}

function sortHoldingsForExecution(holdings, operationForSymbol) {
